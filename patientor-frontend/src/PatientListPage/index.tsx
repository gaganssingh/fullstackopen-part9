         ...
         <Table celled>
            <Table.Body>
               <Table.Row>
                  <Table.Cell>
                     <h2>
                        {props.date} <Icon name="stethoscope" /> {props.emp}
                     </h2>
                     <p>{props.desc}</p>
                  </Table.Cell>
               </Table.Row>
            ...
            <Table celled>
               <Table.Header>
                  <Table.Row>
                     ...
                     <Table.HeaderCell>
                        Add Occupational Healthcare Entries
                     </Table.HeaderCell>
                  </Table.Row>
               </Table.Header>
               <Table.Body>
                  {Object.values(patients).map((patient: Patient) => (
                     <Table.Row key={patient.id}>
                        <Table.Cell>
                           {" "}
                           <Button onClick={() => click(patient.id)}>
                              {" "}
                              {patient.name}
                           </Button>
                        </Table.Cell>
                        ...
                        <Table.Cell>
                           <AddEntryModal
                              ...
                              onClose={closeModal1}
                           />
                           <Button onClick={() => openModal1(patient.id)}>
                              {" "}
                        ...
                        <Table.Cell>
                           <AddEntryModal2
                              ...
                              onClose={closeModal2}
                           />
                           <Button onClick={() => openModal2(patient.id)}>
                              {" "}
                              Add Hospital Entry
                           </Button>{" "}
                        </Table.Cell>
                        <Table.Cell>
                           <AddEntryModal1
                              ...
                              onClose={closeModalO}
                           />
                           <Button onClick={() => openModalO(patient.id)}>
                              {" "}
